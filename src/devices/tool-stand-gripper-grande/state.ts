...
export const toolStandGripperPiccoloSchema = z.object({
  kind: z.literal('tool-stand-gripper-grande'),
  id: z.literal('tool-stand-gripper-grande'),
  label: z.string(),
...
export type ToolStandGripperugrandeState = z.infer<
...
export const initialState: ToolStandGripperugrandeState = {
  kind: 'tool-stand-gripper-grande',
  id: 'tool-stand-gripper-grande',
  label: 'Gripper grande',
  parentId: 'tool-stand',
  status: 'idle',
  stato: 'a-magazzino',
  dx: 120,
