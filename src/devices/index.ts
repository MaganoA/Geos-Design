...
const registry: Record<string, RegisteredDevice> = {
  ...
  // Robot, dispenser, tool stand, resin system (root-level devices)
  ...
  'tool-stand':               { meta: toolStandMeta.meta,         Panel: StubPanel, Toolbar: StubToolbar },
  'erogazione-resina':        { meta: resinaMeta.meta,            Panel: StubPanel, Toolbar: StubToolbar },

  // Baie (raw + finished slab bays)
  baie:                       { meta: baieMeta.meta,              Panel: StubPanel, Toolbar: StubToolbar },
  ...
  // Piani aspirati (vacuum tables)
  'piani-aspirati':           { meta: pianiAspiratiMeta.meta,     Panel: StubPanel, Toolbar: StubToolbar },
  ...
  // Speed (rotating table + accessories)
  speed:                      { meta: speedMeta.meta,             Panel: StubPanel, Toolbar: StubToolbar },
  'speed-soffiatore':         { meta: speedSoffiatoreMeta.meta,   Panel: StubPanel, Toolbar: StubToolbar },
  'speed-barra-lavaggio':     { meta: speedBarraMeta.meta,        Panel: StubPanel, Toolbar: StubToolbar },

  // Impianti (vacuum/water/air subsystems)
  impianti:                   { meta: impiantiMeta.meta,          Panel: StubPanel, Toolbar: StubToolbar },
  ...
  'sicurezza-elettroserrature': { meta: elettroserratureMeta.meta, Panel: StubPanel, Toolbar: StubToolbar },
}
