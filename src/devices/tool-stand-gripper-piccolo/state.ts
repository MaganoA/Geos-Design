...
export const toolStandGripperPiccoloSchema = z.object({
  kind: z.literal('tool-stand-gripper-piccolo'),
  id: z.literal('tool-stand-gripper-piccolo'),
  label: z.string(),
...
export type ToolStandGripperPiccoloState = z.infer<
...
export const initialState: ToolStandGripperPiccoloState = {
  kind: 'tool-stand-gripper-piccolo',
  id: 'tool-stand-gripper-piccolo',
  label: 'Gripper piccolo',
  parentId: 'tool-stand',
  status: 'idle',
  stato: 'a-magazzino',
  dx: 60,
